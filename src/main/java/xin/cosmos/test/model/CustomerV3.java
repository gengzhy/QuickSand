...
public class CustomerV3 {
    ...
    private String c7;
    @JSONField(name = "客户身份证件/证明文件号码")
    @ExcelProperty(value = "客户身份证件/证明文件号码")
    private String c8;
    ...
    private String c16;
    @JSONField(name = "客户名称1")
    @ExcelProperty(value = "客户名称1")
    private String c17;
    @JSONField(name = "客户身份证号码")
    @ExcelProperty(value = "客户身份证号码")
    private String c18;
    @JSONField(name = "省市区")
